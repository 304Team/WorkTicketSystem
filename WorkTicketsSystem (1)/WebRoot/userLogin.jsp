...
<html>
  <head>
   ...
   <body>
         <div id="login_frame">
                 <p id="image_logo" style="font-size:30px;color:black;text-shadow: 5px 5px 5px white;">普通用户登录</p>
               <form method="post">
                     ...
                     <div id="login_control">
                             <input type="button" id="btn_login" value="登录" onclick="ulogincheck.jsp"/>
                     </div>
               </form>
         </div>
  </body>
